...
2.  Barbiero, J., **Calderan, M.**, & Mioni, G., The contribution of cerebellum in time perception: A systematic review and meta-analyses. 
    
2.  Toffoli, L., **Calderan, M.**, Stefanelli, G., Duma, G.M., Del Popolo Cristaldi, F., Duma, G., Pastore, M., Frisina, S., Tarantino, V., & Mento, G., I am talking to you! Engagement modulates the effects of digital contents exposure on preschoolers’ adaptive cognitive control. 
    
3.  **Calderan, M.**, van Dooren, R., Sellaro, R., & Jongkees, J.B., Dynamic and contextual modulation of constraints on cognitive control. 
...
2.  Stefanelli G., Toffoli L., **Calderan M.**, Duma G. M., Del Popolo
    Cristaldi F., Tarantino V., Visalli A., Sellaro R. & Mento G. Super Learning Bros:
...
4.  Degasperi, G.,**Calderan, M.**, Mioni, G., Meisner, M., Blachnio, A., Hryhorchuk, I.,  Plucinska, E., Sobol, M., & Cellini, N. The role of sleep, circadian rhythms, balanced time perspective on perinatal depression symptoms. **Poster** at the Cognitive Science Arena, Brixen (Italy), February 2024.

4.  Toffoli, L.,**Calderan, M.**, Duma, G. M., Frisina, S., Tarantino V., & Mento, G. I'm talking to you! Interactive digital content effects on children's adaptive cognitive control. **Talk** at the Cognitive Science Arena, Brixen (Italy), February 2024.
    
    
5.  **Calderan, M.**, Visalli, A., Sellaro, R., & Cellini, N. The Effects
...
4.  Toffoli, L., **Calderan, M.**, Del Popolo Cristaldi, F., Duma, G. M., Calcagnì, A., Pastore, M., Tarantino, V., & Mento, G. Can I afford one more candy? How motivational contexts shape adaptive cognitive control in children. **Talk** at the Cognitive Science Arena, Brixen (Italy), February 2023.
...
-  **Bayesian Multiple Testing**. STAT-Talk Series, Methodology and Statistics Department, Institute of Psychology, Leiden University, Leiden, The Netherlands. 18th September 2025.


## Awards and Grants

-  **Travel Grant**: European Conference on Visual Perception, Mainz,
    (Germany).
-  **Travel Grant**: qHelp international seminar on Quantitative
    Psychology. Arrifana (Portugal)
- **Painter Award**: Best Poster, Cognitive Science Arena, Brixen,
    (Italy).
...
- **Test per le organizzazioni** (21 hours, 3 CFU). 2nd semester of the 2025/2026 academic year. Lecturer (titolare di modulo) for the Master’s Degree in Psicologia Sociale, del Lavoro e della Comunicazione, University of Padova.
...
-  **Learning in Dynamic Environments: A Tentative Implementation of the Volatile Kalman Filter in STAN.** Presentation (1 hr.) on a Bayesian-based implementation of a learning algorithm for the
...
-  **Assistance** during lectures for the course **Testing Psicologico** (Prof. Tatiana Marci), Bachelor's degree in Scienze psicologiche dello sviluppo, della personalità e delle relazioni interpersonali, University of Padova (14 hrs.).
...
-  **A Practical Introduction to Evidence Accumulation Models in Visual Perception Research**. European Conference on Visual Perception,
    Mainz (Germany). 24 August 2025 (2.30 hr.). Material:
...
tibble::tribble(
    ...
    "Dr. Bryant Jongkees", "Univerisity of Leiden, The Netherlands", "2024 - Present", 
      c("Stability and flexibility in cognitive control."),
    "Dr. Antonino Visalli", "University of Modena-Reggio Emilia, Italy", "2023 - Present", 
      c("Computational models of learning and control.")
) |>
  cvevents(when = "dates", what = "degree", where = "institution", details = "details")
```
...
-   Toffalini, E., **Calderan, M.**, Pagan, R., Tobia, V. & Sonuga-Barke, E. A   Critical Tails or Types? A Critical Systematic Review of Taxometric Studies of  Neurodevelopmental Conditions. Under review in *Journal of Child Psychology and Psychiatry* <https://github.com/EnricoToffalini/Taxometrics-Neurodevelopmental-Disorders/tree/main>
